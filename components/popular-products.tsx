...
export function PopularProducts() {
  ...
  useEffect(() => {
    setIsClient(true)
    // Get 4 random products with high ratings
    const popularProducts = [...dummyProducts]
  ...
  return (
    <div className="my-12">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/produk?sort=popular" className="text-sm font-medium text-primary hover:underline">
          Lihat Semua
        </Link>
      </div>
